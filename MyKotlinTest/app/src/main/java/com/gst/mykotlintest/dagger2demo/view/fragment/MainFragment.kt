package com.gst.mykotlintest.dagger2demo.view.fragment
...
import com.gst.mykotlintest.dagger2demo.util.KeyboardUtil
...
import com.gst.mykotlintest.dagger2demo.presenter.GithubUserPresenter
...
class MainFragment : Fragment(), GithubUserPresenter.View {
    ...
    private fun displayAvatarImage(avatarUrl: String) {
        Glide.with(this).load(avatarUrl).into(ivProfile)
    }
